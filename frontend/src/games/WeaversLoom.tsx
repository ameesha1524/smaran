// Orphaned — the Weaver's Loom was retired in favour of Duck
// Roll Call (visuospatial working memory / Domain 6). Kept for reference only.
//
// The body is commented out rather than deleted: it still passes 'WEAVERS_LOOM'
// to useAdaptiveSession(), which is no longer a valid GameType, and its
// Progress export has moved to components/GameShell.tsx (FamilyGrove now
